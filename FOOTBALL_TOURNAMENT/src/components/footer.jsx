    ...
    return (
        <div>
            <footer className=" bg-gray-900 text-white text-center py-5">   
                ...
                <div>   
                    <h6 className="font-bold text-2xl pb-4">Morning Footballers</h6>
                    ...
                    <div className="flex justify-center items-center gap-3 mt-1 mb-4">
                        ...
                        <a href="https://www.instagram.com/">
                            <i className="pi pi-instagram text-2xl hover:scale-125 transition-transform duration-300"></i>
                        </a>
                ...
                <p className="text-gray-300 bg-cyan-950 text-sm">
            ...
            <div className=' bg-gray-800 text-zinc-300 text-center'>
                    <p className='text-xs'>Design by oneO8.tech</p>
                </div>
        </div>
